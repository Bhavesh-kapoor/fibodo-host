...
class CreateMembershipPlanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['required', Rule::enum(MembershipType::class)],
            'plan_type' => ['required', Rule::enum(MembershipPlanType::class)],
            ...
            'billing_period' => ['required', Rule::enum(MembershipBillingPeriod::class)],
